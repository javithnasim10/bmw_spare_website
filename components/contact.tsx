      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Have questions? Our team is ready to help you find the right parts
          </p>
        </div>
              ...
              <CardContent className="p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">info@bmwspareparts.com</p>
                    <p className="text-muted-foreground">sales@bmwspareparts.com</p>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">123 Auto Parts Boulevard</p>
